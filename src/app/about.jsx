...
export function OnlineCourse() {
  return (
    <>
      ...
      <section
        id="about"
        className="relative overflow-hidden bg-white px-6 py-20 sm:px-8 md:py-24 lg:px-12 lg:py-28"
      >
        ...
        <div className="container relative z-10 mx-auto max-w-7xl">
          <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-24">
            ...
            <div className="relative flex min-h-[420px] items-center justify-center lg:min-h-[520px]">
              {/* Outer Circle */}
              <div className="absolute h-[300px] w-[300px] rounded-full border border-[#58B947]/20 sm:h-[390px] sm:w-[390px] lg:h-[500px] lg:w-[500px]" />

              {/* Inner Circle */}
              <div className="absolute h-[230px] w-[230px] rounded-full border border-[#123B66]/10 sm:h-[310px] sm:w-[310px] lg:h-[400px] lg:w-[400px]" />

              {/* Glow */}
              <div className="absolute h-[250px] w-[250px] rounded-full bg-[#58B947]/10 blur-3xl" />

              {/* Logo */}
              <div className="relative z-10 flex h-[280px] w-full max-w-[500px] items-center justify-center sm:h-[360px] lg:h-[450px]">
                <img
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-3">
            ...
            <div className="flex items-center justify-center lg:col-span-1">
              <div className="overflow-hidden rounded-xl shadow-lg">
                <img
                  ...
                  className="h-auto max-h-[600px] w-auto max-w-[380px] object-contain"
                />
              </div>
            </div>
            ...
            <div className="lg:col-span-2 lg:pl-12">
              ...
              {/* Description */}
              <p className="mb-10 max-w-3xl text-left text-lg leading-relaxed text-gray-500">
                Nexagram is a forward-thinking digital marketing company focused
              ...
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
                {FEATURES.map(({ icon: Icon, title, description }) => (
                  <div
                    key={title}
                    className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-lg"
                  >
                    {/* Icon */}
                    <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-lg bg-gray-900 text-white">
